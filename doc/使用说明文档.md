WDT 帮助文档
``` log
wdt: WDT Warp-speed Data Transfer. v 1.26.1603040 p 26. Sample usage:
...
Use --help to see all the options.
 ...
 Flags from /home/hjmao/workspace/pdt/src/wdt/wdtCmdLine.cpp:
    ...
    -protocol_version (Protocol version to use, this is used to simulate
      protocol negotiation) type: int32 default: 0
